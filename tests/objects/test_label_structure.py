...
def test_add_and_get_classification_instances_to_audio_label_row(all_types_ontology):
    ...
    with pytest.raises(LabelRowError, match=r".*and has overlapping frames on the ranges.*[\(0:0\)]"):
        label_row.add_classification_instance(overlapping_classification_instance)
...
def test_get_annotations_from_non_geometric_classification(all_types_ontology) -> None:
    ...
    annotation = classification_instance._instance_data.annotation_metadata
