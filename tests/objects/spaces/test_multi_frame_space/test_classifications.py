...
def test_put_classification_on_video_space(ontology):
    ...
    annotations = list(video_space_1.get_annotations(type_="classification"))
...
def test_put_classification_on_invalid_frames(ontology):
    ...
    assert exceed_frame_error.value.message == "Frame 100 is invalid. The max frame on this file is 9."
...
def test_remove_classification_from_frames_on_video_space(ontology):
    ...
    annotations_before_removing = list(video_space_1.get_annotations(type_="classification"))
...
def test_get_classification_annotations(ontology):
    ...
    # Act
    classification_annotations = list(video_space_1.get_annotations(type_="classification"))
...
def test_get_classification_annotations_with_filter_classifications(ontology):
    ...
    annotations_for_classification_1 = list(
        video_space_1.get_annotations(
            type_="classification", filter_instance_hashes=[classification_instance_1.classification_hash]
        )
    )
    ...
    annotations_for_classification_2 = list(
        video_space_1.get_annotations(
            type_="classification", filter_instance_hashes=[classification_instance_2.classification_hash]
        )
    )
...
def test_update_annotation_from_object_annotation(ontology):
    ...
    assert current_label_row_dict["spaces"]["video-1-uuid"]["labels"] == {}
    ...
    expected_answers = {
        classification_instance_1.classification_hash: {
            ...
            "featureHash": "jPOcEsbw",
            "spaces": {"video-1-uuid": {"range": [[1, 1]], "type": "frame"}},
            "range": [],
            "createdAt": format_datetime_to_long_string(date),
            "createdBy": None,
            "confidence": 1.0,
    ...
    assert new_label_row_dict["spaces"]["video-1-uuid"]["labels"] == {}
