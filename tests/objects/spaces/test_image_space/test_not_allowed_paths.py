...
def test_place_object_on_image_space_throws_error_if_object_has_frames(ontology):
    # Arrange
...
def test_place_object_on_image_space_throws_error_if_object_has_dynamic_attributes(ontology):
    # Arrange
    label_row = LabelRowV2(DATA_GROUP_METADATA, Mock(), ontology)
    label_row.from_labels_dict(DATA_GROUP_TWO_IMAGES_NO_LABELS)
    image_space_1 = label_row.get_space(id="image-1-uuid", type_="image")
