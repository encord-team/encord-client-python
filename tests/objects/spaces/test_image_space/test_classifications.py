...
def test_put_classification_on_image_space(ontology):
    ...
    annotations = list(image_space_1.get_annotations(type_="classification"))
...
def test_put_classification_on_frames_with_overwrite_on_image_space(ontology):
    ...
    annotations_on_classifications = list(image_space_1.get_annotations(type_="classification"))
