...
def test_place_classification_on_audio_space(ontology):
    ...
    annotations = list(audio_space_1.get_classification_instance_annotations())
    ...
    expected_dict = {
        new_classification_instance.classification_hash: {
            ...
            "range": [],
            "spaces": {"audio-1-uuid": {"range": [], "type": "frame"}},
            "createdBy": None,
            "lastEditedBy": None,
            "manualAnnotation": True,
        }
...
def test_place_classification_replace_overlapping_strategy_exists(ontology):
    ...
    # Assert
    classification_annotations = list(audio_space_1.get_classification_instance_annotations())
...
def test_remove_classification_from_audio_space(ontology):
    ...
    # Assert
    classifications_on_label_row = label_row._get_classification_instances(include_spaces=False)
...
def test_get_classification_annotations_with_filter_classifications(ontology):
    ...
    annotations_for_classification_1 = list(
        audio_space_1.get_classification_instance_annotations(
