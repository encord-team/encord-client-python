...
def test_place_classification_on_audio_space(ontology):
    ...
    annotations = list(audio_space_1.get_annotations(type_="classification"))
...
def test_place_classification_replace_overlapping_strategy_exists(ontology):
    ...
    # Assert
    classification_annotations = list(audio_space_1.get_annotations(type_="classification"))
