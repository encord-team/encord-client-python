...
def test_put_object_on_audio_space(ontology):
    ...
    annotations = list(audio_space_1.get_annotations(type_="object"))
...
def test_put_objects_with_merge_overlapping_strategy(ontology):
    ...
    # Assert
    object_annotations = list(audio_space_1.get_annotations(type_="object"))
...
def test_remove_object_from_ranges_on_audio_space(ontology):
    ...
    annotations_on_space = list(audio_space_1.get_annotations(type_="object"))
...
def test_add_object_to_two_spaces(ontology):
    ...
    annotations_on_audio_space_1 = list(audio_space_1.get_annotations(type_="object"))
    ...
    annotations_on_audio_space_2 = list(audio_space_2.get_annotations(type_="object"))
...
def test_update_annotation_for_object_reflected_on_different_spaces(ontology):
    ...
    object_annotation_on_audio_space_2 = list(audio_space_2.get_annotations(type_="object"))[0]
    ...
    assert object_annotation_on_audio_space_2.created_at == new_date
    assert object_annotation_on_audio_space_2.last_edited_by == new_name
    assert object_annotation_on_audio_space_2.last_edited_at == new_date

    # But range is still the same
    assert object_annotation_on_audio_space_2.ranges == [current_range]
...
def test_get_object_ranges_on_audio_space(ontology):
    # Arrange
    label_row = LabelRowV2(DATA_GROUP_METADATA, Mock(), ontology)
    label_row.from_labels_dict(DATA_GROUP_TWO_AUDIO_NO_LABELS)
    audio_space_1 = label_row.get_space(id="audio-1-uuid", type_="audio")
    ...
    audio_space_1.put_object_instance(object_instance=object_instance, ranges=range_1)
    audio_space_1.put_object_instance(object_instance=object_instance, ranges=range_2, on_overlap="merge")

    # Act
    ranges = audio_space_1.get_object_ranges(object_instance)

    # Assert
    assert ranges == [range_1, range_2]


def test_get_object_ranges_on_multiple_spaces(ontology):
    # Arrange
    label_row = LabelRowV2(DATA_GROUP_METADATA, Mock(), ontology)
    label_row.from_labels_dict(DATA_GROUP_TWO_AUDIO_NO_LABELS)
    audio_space_1 = label_row.get_space(id="audio-1-uuid", type_="audio")
    ...
    audio_space_1.put_object_instance(object_instance=object_instance, ranges=range_1)
    audio_space_2.put_object_instance(object_instance=object_instance, ranges=range_2)

    # Act & Assert
    assert audio_space_1.get_object_ranges(object_instance) == [range_1]
    assert audio_space_2.get_object_ranges(object_instance) == [range_2]


def test_get_object_ranges_raises_if_object_not_on_space(ontology):
    # Arrange
    label_row = LabelRowV2(DATA_GROUP_METADATA, Mock(), ontology)
    label_row.from_labels_dict(DATA_GROUP_TWO_AUDIO_NO_LABELS)
    audio_space_1 = label_row.get_space(id="audio-1-uuid", type_="audio")
    ...
    with pytest.raises(LabelRowError):
        audio_space_1.get_object_ranges(object_instance)


def test_range_list_raises_for_space_based_object(ontology):
    # Arrange
    label_row = LabelRowV2(DATA_GROUP_METADATA, Mock(), ontology)
    label_row.from_labels_dict(DATA_GROUP_TWO_AUDIO_NO_LABELS)
    audio_space_1 = label_row.get_space(id="audio-1-uuid", type_="audio")
    ...
    audio_space_1.put_object_instance(object_instance=object_instance, ranges=Range(start=0, end=100))
