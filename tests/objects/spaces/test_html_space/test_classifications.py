...
def test_place_classification_on_html_space(ontology):
    # Arrange
    ...
    assert classification_on_space._spaces == {html_space_1.space_id: html_space_1}

    annotations = html_space_1.get_classification_instance_annotations()
    ...
    expected_dict = {
        new_classification_instance.classification_hash: {
            ...
            "range": [],
            "spaces": {"html-1-uuid": {"range": [], "type": "html"}},
            "createdBy": None,
            "lastEditedBy": None,
            "manualAnnotation": True,
        }
...
def test_place_classification_where_classification_already_exists(ontology):
    ...
    html_space_1.put_classification_instance(classification_instance=classification_instance_1)
...
def test_place_classification_on_where_classification_of_same_class_already_exists(ontology):
    ...
    # Act
    with pytest.raises(LabelRowError) as e:
        html_space_1.put_classification_instance(classification_instance=classification_instance_2)
...
def test_place_classification_replace_overlapping_strategy_exists(ontology):
    ...
    # Act
    html_space_1.put_classification_instance(classification_instance=classification_instance_2, on_overlap="replace")

    # Assert
    classification_annotations = html_space_1.get_classification_instance_annotations()
...
def test_remove_classification_from_html_space(ontology):
    # Arrange
    label_row = LabelRowV2(DATA_GROUP_METADATA, Mock(), ontology)
    label_row.from_labels_dict(DATA_GROUP_TWO_HTML_NO_LABELS)
    html_space_1 = label_row._get_space(id="html-1-uuid", type_="html")
    ...
    # Act
    html_space_1.remove_classification_instance(new_classification_instance.classification_hash)
...
def test_get_classification_annotations(ontology):
    ...
    html_space_1.put_classification_instance(
...
def test_get_classification_annotations_with_filter_classifications(ontology):
    ...
    # Act
    annotations_for_classification_1 = html_space_1.get_classification_instance_annotations(
    ...
    annotations_for_classification_2 = html_space_1.get_classification_instance_annotations(
    ...
    assert first_annotation_for_classification_2.space.space_id == "html-1-uuid"
