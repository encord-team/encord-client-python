"""
Code Block Name: Merge Projects - US
"""
...
def create_target_project(user_client, project_hashes_to_merge):
    ...
    for p_hash in project_hashes_to_merge:
        ...
        if not ontology_hash:
            ...
            raise Exception(
                f"All projects must share the same ontology but "
                f"https://app.us.encord.com/projects/view/{p_hash}/summary. does not!"
            )
...
def main(project_hashes_to_merge):
    ...
    for source_p_hash in project_hashes_to_merge:
        ...
        for lr_s in tqdm(source_project.list_label_rows_v2()):
            ...
            lr_t.save()
    print("Done!")
    print(f"Access project on https://app.us.encord.com/projects/view/{target_project.project_hash}/summary")
