...
DATA_UNIT_ID_01 = (
    "06b485bf-77be-40df-96c6-b61e8714f1b6"  # Specify a data_hash for a data unit belonging to a Dataset being copied
)
DATA_UNIT_ID_02 = (
    "2e3f10c3-fe67-4d93-844d-a7030f510ab1"  # Specify a data_hash for a data unit belonging to a Dataset being copied
)
DATA_UNIT_ID_03 = (
    "1041da61-d63c-4489-9001-4a56fe37f1f3"  # Specify a data_hash for a data unit belonging to a Dataset being copied
)
DATA_UNIT_ID_04 = (
    "5c981777-7324-47f2-80c9-c27018db0a34"  # Specify a data_hash for a data unit belonging to a Dataset being copied
)
DATA_UNIT_ID_05 = (
    "42e6aaf9-4cd8-4647-b9a6-37ba229c7e54"  # Specify a data_hash for a data unit belonging to a Dataset being copied
)
DATA_UNIT_ID_06 = (
    "84f41e2a-f1fd-4b4d-91d0-bb4f3c64c41a"  # Specify a data_hash for a data unit belonging to a Dataset being copied
)
