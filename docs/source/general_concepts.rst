...
* **Dataset**: the space where the data it self lives. Datasets can be reused across multiple projects and contains no labels or annotations them selves. For a |platform| specific introduction, please refer to the |platform| :xref:`dataset` page.
* **Project**: the space where ontology information, labels, annotations, and reviews lives. Projects can be linked to multiple datasets. For a |platform| specific introduction, please refer to the |platform| :xref:`project` page.
