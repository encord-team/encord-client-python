...
class VideoObjectInstance(BaseObjectInstance):
    ...
    def remove_annotation_from_frames(self, frames: Frames) -> None:
...
class VideoClassificationInstance(BaseClassificationInstance):
    def __init__(self, ontology_classification: Classification, *, classification_hash: Optional[str] = None, space: VideoSpace):
