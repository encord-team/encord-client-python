...
class LabelRowMetadata(Formatter):
    ...
    spaces: Dict[str, SpaceInfo]  # no labels information here, just the space information
    ...
    def from_dict(cls, json_dict: Dict) -> LabelRowMetadata:
        ...
        return LabelRowMetadata(
            ...
            last_actioned_by_user_email=json_dict.get("last_actioned_by_user_email", None),
        )
