...
class LayoutSettings(BaseDTO):
    ...
    Args:
        ...
        is_multilayer: If true, the labels apply to all items in the data group. Only applicable for images of the same aspect ratios.
    """

    fixed_layout: bool = False
    tile_settings: Optional[Dict[str, TileSettings]] = None
    is_multilayer: Optional[bool] = None
