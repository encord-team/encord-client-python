...
class MetadataSchema:
    ...
    **Methods:**
    ...
    def add_embedding(self, k: str, *, size: int) -> None:
        ...
        Raises:
            :class:`~encord.metadata_schema.MetadataSchemaError`: If the key `k` is already defined in the schema.
        """
    ...
    def add_enum_options(self, k: str, *, values: Sequence[str]) -> None:
        ...
        Raises:
            :class:`~encord.metadata_schema.MetadataSchemaError`: If the key `k` is not defined in the schema or is not an enum.
        """
    ...
    def add_scalar(
        ...
        *,
        ...
        Raises:
            :class:`~encord.metadata_schema.MetadataSchemaError`: If the key `k` is already defined in the schema with a conflicting type.
    ...
    def delete_key(self, k: str, *, hard: bool = False) -> None:
        ...
        Args:
            k: The key for which the metadata type is being deleted.
            hard: If the deletion should prevent indexing of this key unconditionally.
                Setting this to true prevents restoring the type definition in the future.

        Raises:
            :class:`~encord.metadata_schema.MetadataSchemaError`: If the key `k` is already deleted or not present in the schema
        """
        if k not in self._schema:
    ...
    def restore_key(self, k: str) -> None:
        ...
        Args:
            k: The key for which the metadata type is to be restored.

        Raises:
            :class:`~encord.metadata_schema.MetadataSchemaError`: If the key `k` is not already deleted or not present in the schema
        """
        if k not in self._schema:
            raise MetadataSchemaError(f"{k} is not defined")
        v = self._schema[k]
    ...
    def has_key(self, k: str) -> bool:
        ...
        Args:
            k: The key for which the metadata type is to be retrieved.
        """
    ...
    def get_key_type(
        ...
        Raises:
            :class:`~encord.metadata_schema.MetadataSchemaError`: If the key `k` is not supported by the current SDK.
        """
        if k not in self._schema:
            return None
        _assert_valid_metadata_key(k)
    ...
    def get_embedding_size(self, k: str) -> int:
        ...
        Raises:
            :class:`~encord.metadata_schema.MetadataSchemaError`: If the key `k` is not defined in the schema or is not an embedding
        """
        if k not in self._schema:
            raise MetadataSchemaError(f"{k} is not defined")
        _assert_valid_metadata_key(k)
    ...
    def get_enum_options(self, k: str) -> Sequence[str]:
        ...
        Returns:
            Sequence: The list of all values associated with an enum type.
